(function () {
    ...
    const MENU_GROUPS = [
        ...
        },
        {
            ...
            label: '발주관리',
            items: [
                { label: '발주요청', icon: 'file-plus', href: 'pages/inventory/purchase-request.html' },
                { label: '발주조회', icon: 'clipboard-list', href: 'pages/inventory/purchase-orders.html', disabled: true }
            ]
        },
        {
            id: 'vendors',
            label: '거래처관리',
            items: [
                { label: '거래처 등록', icon: 'building-2', href: 'pages/inventory/vendors-register.html' },
                { label: '거래처 조회', icon: 'search', href: 'pages/inventory/vendors.html' }
            ]
        },
        {
            id: 'inventory',
