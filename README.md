...
| 담당자              | 도메인                     | 주요 기능 |
| :------------------ | :------------------------- | :--- |
| **서우리**          | 구매/발주, 세금계산서 | 구매/발주 대시보드, 발주 요청, 발주 관리, 입고 등록, 거래처 관리, 세금계산서, 비용 처리 |
| **김슬기**          | 재고관리, 회계관리 | 재고관리 대시보드, 재고 조회, 입출고 이력, 창고 이동, 자동 발주 추천, 회계 대시보드, 계정과목 관리, 거래내역 등록, 합계잔액시산표, 월 마감, 급여 계산/대장, 회계 리포트 |
