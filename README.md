...
## 👥 Team & Roles
*   **김민호 (조장)**: 관리자 / AI — 공통 시스템 아키텍처, JWT 보안, 대시보드 및 AI 챗봇 인프라 구축
*   **서우리**: 회계 / 인사 — 직원 근태 및 급여 정산 시스템, 비용 처리 및 AI 기반 회계 분석 리포트
*   **김슬기**: 구매 / 발주 — 실시간 재고 관리, 발주/거래처 관리 및 AI OCR 활용 자동 발주 시스템
